...
private:
	...
	static bool										 bWorldGeometryDirty;
...
public:
	...
	// Marks environment geometry as changed at runtime.
	static void MarkWorldGeometryDirty();

	// Returns true once when a rebuild has been requested.
	static bool ConsumeWorldGeometryDirty();

	// Deletes cached octree files for current map and octree sizing.
	static void ClearCacheForCurrentWorld();
