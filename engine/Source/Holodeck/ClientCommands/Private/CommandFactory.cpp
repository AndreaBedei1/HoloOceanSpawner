...
UCommand* UCommandFactory::MakeCommand(
	...
	static UCommandMapType CommandMap = {
		...
		{ "SpawnAsset", &CreateInstance<USpawnAssetCommand> },
		{ "ClearSpawned", &CreateInstance<UClearSpawnedCommand> },
		{ "RespawnFromConfig", &CreateInstance<URespawnFromConfigCommand> },
